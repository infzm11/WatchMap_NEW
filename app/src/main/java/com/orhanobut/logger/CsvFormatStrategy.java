    ...
    public static final class Builder {
        ...
        public CsvFormatStrategy build() {
            ...
            if (this.logStrategy == null) {
                ...
                HandlerThread handlerThread = new HandlerThread("AndroidFileLogger." + r0);
                handlerThread.start();
                this.logStrategy = new DiskLogStrategy(new DiskLogStrategy.WriteHandler(handlerThread.getLooper(), absolutePath + File.separatorChar + "logger", MAX_BYTES));
            }
